...
<body>
    ...
    <nav id="nav-bar">
        ...
        <ul class="row">
            <section class="container">
                ...
                <li class="cell active" sectionName="section-members">
    ...
    <div class="members">
        ...
        <div class="profile-card">
            <img src="media/images/12.jpg" data-modal class="profile-image" alt="member-profile">
            <p class="member-name"> Abou Emran </p>
            <p class="location">Cairo, Egypt</p>
            <p class="books-read">43 book read</p>
            <div class="rating">
                <span class="fa fa-star checked"></span>
    ...
    <div class="pagination">
        ...
        <span class="dots-pagination">...</span>
